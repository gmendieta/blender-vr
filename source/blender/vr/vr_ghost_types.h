...
typedef enum _VR_GHOST_TKey {
	VR_GHOST_kKeyLeftShift = 0x100,
	VR_GHOST_kKeyRightShift,
	VR_GHOST_kKeyLeftControl,
	VR_GHOST_kKeyRightControl,
	VR_GHOST_kKeyLeftAlt,
	VR_GHOST_kKeyRightAlt,
...
typedef enum _VR_GHOST_TEventType {
	...
	VR_GHOST_kEventVRMotion,		/// 3d motion event
...
struct VR_GHOST_EventVRMotion : public VR_GHOST_Event
{
	VR_GHOST_EventVRMotion(VR_GHOST_TEventType type, float x, float y, float z) :
		VR_GHOST_Event(type),
		m_x(x),
		m_y(y),
		m_z(z)
